          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-neutral-600 max-w-2xl">
                ...
                providing financial support for education, medical treatments,
                gender-affirming surgeries, mental health services, and legal
                aid to the LGBTQIA+ community and women in need.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-neutral-600">
              We offer financial assistance across multiple dimensions to ensure
              holistic support for your unique needs and challenges.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Support for tuition fees, educational materials, and skill
                  development programs to empower through knowledge and
                  opportunity.
                </p>
            ...
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Financial assistance for essential medical procedures,
                  treatments, and healthcare services for improved wellbeing.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Support for gender-affirming surgeries and treatments that
                  help individuals align their physical appearance with their
                  gender identity.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
            ...
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Funding for therapy, counseling, and mental health services to
                  support emotional wellbeing and psychological resilience.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Assistance for legal consultations, documentation, and
                  representation to navigate legal challenges and protect
                  rights.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
            ...
            <div className="group relative bg-white rounded-2xl shadow-soft border border-primary-100/50 overflow-hidden hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  Immediate financial relief for urgent situations, crisis
                  interventions, and basic necessities during challenging times.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-neutral-600">
              Our transparent process ensures that support reaches those who
              need it most, through a fair and compassionate evaluation system.
            </p>
          </div>
                ...
                <div className="p-6 bg-primary-50 rounded-xl">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
                      <span className="text-neutral-700">
                        Individuals demonstrating genuine financial need
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
                      <span className="text-neutral-700">
                        For gender-affirming surgeries: Those with psychological
                        clearance and counseling
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <FileText className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
                      <span className="text-neutral-700">
                        Income Proof (Salary Slip, Bank Statement, or an
                        Affidavit)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <FileText className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
                      <span className="text-neutral-700">
                        Medical Clearance Certificate (if applicable)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <FileText className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
                      <span className="text-neutral-700">
                        Letter of intent detailing the significance of support
                        in your life
                      </span>
                    </li>
                  </ul>
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                <div className="relative pl-12 pb-12 border-l-2 border-primary-200">
                  ...
                  <div className="bg-white rounded-xl shadow-soft p-6 border border-primary-100">
                    ...
                    <p className="text-neutral-600 mb-3">
                      Complete and submit the application form along with all
                      required documents. Ensure all information is accurate and
                      complete.
                    </p>
                    <button
                    ...
                    >
                      View Details
                      <ChevronDown
                        className={`w-4 h-4 transform transition-transform ${openSection === "step1" ? "rotate-180" : ""
                          }`}
                      />
                    </button>
                      ...
                      <div className="mt-4 pt-4 border-t border-neutral-100">
                        ...
                        <ul className="space-y-2 text-sm text-neutral-600 mb-4">
                          ...
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Must demonstrate a genuine need for financial
                              assistance
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Should have undergone counseling and received
                              psychological clearance for gender-affirming
                        ...
                        <ul className="space-y-2 text-sm text-neutral-600">
                          ...
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Medical Clearance Certificate from a licensed
                              practitioner
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              A letter of intent detailing why you seek
                              assistance and its significance in your life
                            </span>
                          </li>
                        </ul>
                      </div>
                ...
                <div className="relative pl-12 pb-12 border-l-2 border-primary-200">
                  ...
                  <div className="bg-white rounded-xl shadow-soft p-6 border border-primary-100">
                    ...
                    <p className="text-neutral-600">
                      Our team reviews your application, verifies documents for
                      authenticity, and shortlists based on financial need and
                      readiness.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative pl-12 pb-12 border-l-2 border-primary-200">
                  ...
                  <div className="bg-white rounded-xl shadow-soft p-6 border border-primary-100">
                    ...
                    <p className="text-neutral-600 mb-3">
                      Shortlisted applicants are invited for a panel interview
                      to assess readiness, understanding, and commitment.
                    </p>
                    <button
                    ...
                    >
                      View Details
                      <ChevronDown
                        className={`w-4 h-4 transform transition-transform ${openSection === "step3" ? "rotate-180" : ""
                          }`}
                      />
                    </button>
                    ...
                    {openSection === "step3" && (
                      <div className="mt-4 pt-4 border-t border-neutral-100">
                        <p className="text-sm text-neutral-600 mb-3">
                          The interview panel typically includes a counselor, a
                          community member, and a medical professional who will
                          assess:
                        </p>
                        <ul className="space-y-2 text-sm text-neutral-600">
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Emotional preparedness for the assistance
                ...
                <div className="relative pl-12">
                  ...
                  <div className="bg-white rounded-xl shadow-soft p-6 border border-primary-100">
                    ...
                    <p className="text-neutral-600 mb-3">
                      Applicants are selected based on financial necessity,
                      readiness, and panel recommendations. Successful
                      applicants are notified and funding arrangements are made.
                    </p>
                    <button
                    ...
                    >
                      View Details
                      <ChevronDown
                        className={`w-4 h-4 transform transition-transform ${openSection === "step4" ? "rotate-180" : ""
                          }`}
                      />
                    </button>
                      ...
                      <div className="mt-4 pt-4 border-t border-neutral-100">
                        ...
                        <ul className="space-y-2 text-sm text-neutral-600">
                          ...
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Readiness and genuine intent for the purpose of
                              assistance
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
                            <span>
                              Recommendations from the interview panel
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <div className="w-1 h-1 rounded-full bg-primary-500 mt-2 flex-shrink-0"></div>
              ...
              <div className="bg-primary-50 rounded-xl p-6 border border-primary-100 mt-8">
                ...
                <p className="text-neutral-600 mb-4">
                  The selection process typically takes 3-4 weeks from
                  submission to final decision. Urgent cases may be expedited
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                Fill out the initial screening questionnaire below to begin your
                application process. All information provided is kept strictly
                confidential.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-r from-primary-500 to-accent-terracotta text-white p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1">
                    ...
                    <div className="w-12 h-1 bg-white/30">
                      <div
                        className={`h-full ${formStep >= 4 ? "bg-white" : "bg-transparent"
                          }`}
                      ></div>
                    </div>
                    <div
              ...
              {formStep === 2 && (
                <div className="p-6 md:p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-neutral-700">
                        Please provide a brief description of your situation and
              ...
              {formStep === 3 && (
                <div className="p-6 md:p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-neutral-700">
                        Do you receive any other financial assistance or
                        benefits?
                      </label>
                      <div className="flex gap-4">
                        <label className="inline-flex items-center">
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-neutral-700">
                        Have you availed any financial assistance or benefits
                        from any other Organization, Recently Or in the Past?
                      </label>
                      <div className="flex gap-4">
                        <label className="inline-flex items-center">
                          <input
                            type="radio"
                            name="previous-assistance"
                            value="yes"
                            className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500"
                          />
                          <span className="ml-2 text-neutral-700">Yes</span>
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            Is the medical procedure or treatment urgent?
                          </label>
                          <div className="flex gap-4">
                            <label className="inline-flex items-center">
                              <input
                                type="radio"
                                name="treatment-urgency"
                                value="yes"
                                className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500"
                              />
                              <span className="ml-2 text-neutral-700">Yes</span>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="mt-3">
                            <label className="block text-sm font-medium text-neutral-700 mb-1">
                              If yes, does it cover the required treatment?
                            </label>
                            <div className="flex gap-4">
                              <label className="inline-flex items-center">
                                <input
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            Do you have a support system (family, friends) to
                        ...
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            Are you willing to participate in counseling or
                            support programs if recommended?
                          </label>
                          <div className="flex gap-4">
                            <label className="inline-flex items-center">
                              <input
                                type="radio"
                                name="counseling-willingness"
                                value="yes"
                                className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500"
                              />
                              <span className="ml-2 text-neutral-700">Yes</span>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            ...
                            responsibilities involved in receiving assistance
                        ...
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            Are you willing to provide regular updates on your
                            progress after receiving assistance?
                          </label>
                          <div className="flex gap-4">
                            <label className="inline-flex items-center">
                              <input
                        ...
                        <div className="space-y-2">
                          <label className="block text-sm font-medium text-neutral-700">
                            Have you applied for assistance from our
                            organization before?
                          </label>
                          <div className="flex gap-4">
                            <label className="inline-flex items-center">

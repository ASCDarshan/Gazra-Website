              ...
              {formStep === 1 && (
                <div className="p-6 md:p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-neutral-700">Date of Birth (DD/MM/YYYY)</label>
                      <input
                        type="text"
                        className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-4 mt-2">
                        <label className="inline-flex items-center">
                          <input type="radio" name="gender" value="male" className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500" />
                          <span className="ml-2 text-sm text-neutral-700">Male</span>
                        </label>
                        <label className="inline-flex items-center">
                          <input type="radio" name="gender" value="female" className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500" />
                          <span className="ml-2 text-sm text-neutral-700">Female</span>
                        </label>
                        <label className="inline-flex items-center">
                          <input type="radio" name="gender" value="other" className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500" />
                          <span className="ml-2 text-sm text-neutral-700">Other</span>
                        </label>
                        <label className="inline-flex items-center">
                          <input type="radio" name="gender" value="prefer_not_to_say" className="w-4 h-4 text-primary-600 border-neutral-300 focus:ring-primary-500" />
                  ...
                  <div className="space-y-8"> {/* Increased spacing between major sections */}
                    ...
                    <div className="pt-6 border-t border-neutral-200">
                      ...
                      <div className="flex items-start gap-2">
                        <input type="checkbox" id="declaration-agreement" className="mt-1 w-4 h-4 text-primary-600 border-neutral-300 rounded focus:ring-primary-500" />

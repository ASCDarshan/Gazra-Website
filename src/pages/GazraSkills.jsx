...
const CourseSelectorTabs = ({ selectedCourse, onSelectCourse }) => {
  const courses = [
    { id: 'hospitality', name: 'Hospitality', sub: 'Restaurant Management', icon: ChefHat, gradient: 'from-accent-ochre to-accent-terracotta' },
    { id: 'makeup', name: 'Makeup', sub: 'Professional Artistry', icon: Palette, gradient: 'from-accent-terracotta to-primary-500' },
    { id: 'it', name: 'Digital Marketing', sub: 'SEO & Content Writing', icon: Monitor, gradient: 'from-accent-slate to-primary-600' },
    { id: 'handicrafts', name: 'Handicrafts', sub: 'Artisanal Skills', icon: Layers, gradient: 'from-accent-sage to-accent-ochre' },
  ];
...
const GazraSkills = () => {
  ...
  const renderCourseContent = () => {
    switch (selectedCourse) {
      ...
      default:
        return <HospitalityCourse />; // Fallback to default
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-primary-50/30 to-white">
      ...
      <section id="courses" className="py-16 bg-gradient-to-b from-white to-primary-50/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <CourseSelectorTabs selectedCourse={selectedCourse} onSelectCourse={setSelectedCourse} />

  ...
  snacks: [
    {
      ...
      popular: true,
      chefNotes:
        "A beloved Maharashtrian snack that perfectly balances crunch and flavor.",
    },
    // ... other menu items
  ],
};
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {item.spiceLevel && (
                      <div className="flex items-center">
                        <span
                          className={`w-2 h-2 rounded-full mr-1 ${getSpiceLevelColor(
                            item.spiceLevel
                          )}`}
                        />
          ...
          >
            ...
            >
              ...
              <div className="relative h-64">
                <img
                  src={
                    dishImages[selectedItem.name] || "/api/placeholder/800/400"
                  }
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {Object.entries(selectedItem.nutritionalInfo).map(
                      ([key, value]) => (
                        <div
                          key={key}

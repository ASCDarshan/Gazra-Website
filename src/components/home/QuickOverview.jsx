...
const QuickOverview = () => {
  return (
    <section className="py-16 bg-gradient-to-b from-white to-primary-50 relative overflow-hidden">
      ...
      <div
        className="absolute top-1/4 right-1/4 w-6 h-6 bg-primary-300/40 rounded-full animate-float"
        style={{ animationDelay: "0s" }}
      ></div>
      <div
        className="absolute top-3/4 left-1/4 w-4 h-4 bg-secondary-300/40 rounded-full animate-float"
        style={{ animationDelay: "1.5s" }}
      ></div>
      <div
        className="absolute bottom-1/4 right-2/3 w-8 h-8 bg-accent-ochre/30 rounded-full animate-float"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-6 mb-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary-400 to-primary-500 text-white rounded-full shadow-md animate-pulse-slow">
              <Sparkles className="w-4 h-4 text-white" />
              <span className="font-medium text-sm">EXPLORE OUR WORLD</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-display font-bold text-neutral-800 relative inline-block m-0">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
          <div className="relative group transition-all duration-500 hover:-translate-y-2">
            <div className="relative p-0.5 bg-gradient-to-br from-pink-500 via-primary-400 to-orange-400 rounded-2xl shadow-lg overflow-hidden">
              <div className="relative bg-white p-6 md:p-8 rounded-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base md:text-lg text-neutral-600 mb-6">
                    Gazra is more than just a community space - it&apos;s a
                    movement towards creating an inclusive society where
                    everyone can be their authentic selves. We provide a safe,
                    welcoming environment for the LGBTQIA+ community to connect,
                    grow, and celebrate their identity.
                  </p>
                  <p className="text-base md:text-lg text-neutral-600 mb-6">
                    Founded on principles of respect, compassion, and
                    understanding, our mission is to foster a world where
                    diversity is celebrated.
                  </p>

                  <Link
                    to="/about"
                    className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-pink-500 to-primary-500 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group"
                  >
          ...
          <div className="relative group transition-all duration-500 hover:-translate-y-2">
            <div className="absolute -inset-0.5 bg-gradient-to-br from-orange-400 to-yellow-300 rounded-2xl opacity-0 group-hover:opacity-100 blur-md group-hover:blur transition-all duration-500"></div>

            <div className="relative p-0.5 bg-gradient-to-br from-orange-400 via-yellow-400 to-amber-300 rounded-2xl shadow-lg overflow-hidden">
              <div className="relative bg-white p-6 md:p-8 rounded-xl">
                ...
                <p className="text-base md:text-lg text-neutral-600 mb-6">
                  Our cafe is more than just a place to eat - it&apos;s a
                  vibrant community hub where people can connect, share stories,
                  and feel truly accepted. Enjoy great food and conversations in
                  our welcoming space.
                </p>
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <div className="relative">
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 text-6xl text-primary-300 opacity-50">
              &quot;
            </div>
            <p className="text-xl md:text-2xl italic text-neutral-700 px-12">
              Celebrating diversity isn&apos;t just about tolerance—it&apos;s
              about embracing the beautiful tapestry of human experience that
              makes our community whole.
            </p>
            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 text-6xl text-primary-300 opacity-50">
              &quot;
            </div>
          </div>
          <p className="mt-6 text-lg font-medium text-primary-600">
            The Gazra Community
          </p>
        </div>
      </div>
